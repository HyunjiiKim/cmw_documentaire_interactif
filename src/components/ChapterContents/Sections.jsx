...
export const Witness = ({ content = {} }) => {
    return (
        <div id={`witnessContainer_${content.id}`} className={`flex gap-10 w-full ${content.id % 2 === 0 && 'flex-row-reverse'}`}>
            <video src={content.videoURL} controls className="max-w-[860px]" />
            <div className={`flex flex-col justify-end mr-[60px] gap-20 ${content.id % 2 === 0 && "text-right"}`}>
                <div>
