...
export const HorizontalNav = () => {
  ...
  return (
    <div
      id="horizontalNav"
      className="fixed z-100 w-[120px] h-full border-r border-white py-10 px-4"
    >
      <div className="flex flex-col justify-between items-center h-full">
        <div className="rotate-270 text-white">
          {t("name.pre")}{" "}
          <strong className="text-primary-1">{t("name.post")}</strong>
        </div>
        <div
          className="cursor-pointer rotate-90 text-white p-2 border-white border-1 w-fit"
...
export const TopNav = () => {
  ...
  return (
    <div
      id="TopNav"
      className="w-full flex justify-between items-center border-b-1 border-white px-4"
    >
      ...
      {show && (
        <div
          id="showMenu"
          className="absolute top-0 left-[120px] text-white bg-black z-20 w-160 h-full"
        >
