...
const Archives = () => {
  ...
  const img = [
    ...
    {
      id: "img-3",
      src: "../assets/img/archives/Enterrement_d'une_fillette_sud-coréenne_avant_le_déplacement_des_habitants_de_son_village_vers_un_camp_de_réfugiés.jpeg",
    ...
    {
      id: "img-4",
      src: "../assets/img/archives/Évacuation_par_l'US_Navy_de_réfugiés_en_provenance_de_Corée_du_Nord.jpg",
    ...
    {
      id: "img-5",
      src: "../assets/img/archives/Jeunes_mendiants.jpeg",
